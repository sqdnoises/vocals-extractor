...
if [[ ! -d "Music-Source-Separation-Training" ]]; then
    ...
    echo "⏳ Cloning git repository https://github.com/ZFTurbo/Music-Source-Separation-Training [branch: main]"
    git clone -b main https://github.com/ZFTurbo/Music-Source-Separation-Training
